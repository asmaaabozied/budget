...
<!---------------------------------------------- header --------------------------------------------->
    ...
    <h1 style="text-align:right;font-size:2rem">لائحة الشحن</h1>
    ...
    <div class="card invoice-number">
        <table style="direction:rtl">
            ...
            <tr>
                <td>رقم الشحنة &nbsp;  {{$bill_number}}_{{$id}} </td>
                <td>{{$purchaser->name}}</td>
                <td>{{$payment_type}}</td>
            </tr>
            <tr>
                <td>تاريخ التوريد &nbsp; {{$created_at}} </td>
                <td>{{$purchaser->address}}</td>
                <td></td>
            </tr>
            <tr>
                <td>رقم الطلبية &nbsp; {{$bill_number}} </td>
                <td></td>
                <td></td>
            </tr>
