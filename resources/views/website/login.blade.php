    ...
    <div class="user-data-page clearfix d-lg-flex">
        <div class="illustration-wrapper d-flex align-items-center justify-content-between flex-column">
            ...
            <div class="illustration-holder">
                <img src="{{asset('website/images/assets/ils_08.svg')}}" alt="" class="illustration">
                <img src="{{asset('website/images/assets/ils_08.1.svg')}}" alt="" class="shapes shape-one">
                <img src="{{asset('website/images/assets/ils_08.2.svg')}}" alt="" class="shapes shape-two">
            </div>
        </div> <!-- /.illustration-wrapper -->

        <div class="form-wrapper">
            <div class="d-flex justify-content-between">
                <div class="logo"><a href="index.html"><img src="{{asset('website/images/logo/deski_01.svg')}}" alt=""></a></div>
