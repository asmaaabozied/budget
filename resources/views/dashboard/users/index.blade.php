                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">@lang('site.admins')</a>
                                </li>
                                <!-- <li class="breadcrumb-item active"> @lang('site.show') </li> -->
                            </ol>
                        </div>
                        <h4 class="page-title">@lang('site.admins')</h4>
                    </div>
                </div>
            </div>
            ...
            <section class="content">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title" style="margin-bottom: 15px">@lang('site.admins')
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $user->phone }}</td>
                                    <td>{{ $user->email }}</td>
                                    <td><img src="{{ $user->image_path }}" style="width: 50px;height: 50px;"
                                            class="img-thumbnail" alt=""></td>

                                    @if( $user->status==0)
                                    <td style="margin: 5px;" class="badge bg-red">@lang('site.inactive')
                                    </td>
                                    @elseif( $user->status==1)
                                    <td style="margin: 5px;" class="badge bg-green">@lang('site.active')
                                    </td>
                                    @endif
