            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('dashboard.attendees.update', $leave->id) }}" method="post"
...
{{--                                        <option selected> @lang('site.select')</option>--}}
                                    ...
                                    <div class="col-md-6 form-group col-12 p-2">
                                        ...
                                        <input type="date" name="date" class="form-control" value="{{$leave->date}}"
                                               disabled readonly>
                                    </div>
                            </div>
                            <div class="row">
...
{{--                                        class="form-control" disabled readonly>{{$leave->description_en}}--}}
{{--                                </textarea>--}}
{{--                                </div>--}}
