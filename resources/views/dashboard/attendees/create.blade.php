...
<div class="content">
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">@lang('site.attendees')</a>
                            </li>
                            <li class="breadcrumb-item active"> @lang('site.add')</li>
                        </ol>
                    </div>
                    <h4 class="page-title">@lang('site.attendees')</h4>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <form action="{{ route('dashboard.attendees.store') }}" method="post" enctype="multipart/form-data">

                        {{ csrf_field() }}
                        {{ method_field('post') }}
                        <div class="card-body">
                            <h4 class="card-title">@lang('site.attendees')</h4>
                            @include('partials._errors')

                            <!--<form action="{{ route('dashboard.attendees.store') }}" method="post"-->
                            ...
                            <div class="row">
                                ...
                                {{--                                                data-placeholder="Choose..." name="employe_id" required>--}}
                                {{--                                            <option> @lang('site.select')</option>--}}
                                {{--                                            @foreach(\App\User::get() as $user)--}}
                                {{--                                                <option value="{{$user->id}}">
                                {{$user->name ?? ''}} {{$user->father_name ?? ''}} {{$user->family_name ?? ''}}
                                </option>--}}
                                {{--                                            @endforeach--}}
                                {{--                                        </select>--}}
                                {{--                                    </div>--}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-60 form-group col-12 p-2">
                                    ...
                                    <select class="form-control" name="period_id" required>
                                        ...
                                        <option value="{{$period->id}}"> {{$period->name_ar}} </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-60 form-group col-12 p-2">
                                ...
                                {{--                                        </select>--}}
                                {{--                                    </div>--}}
                                {{--                                    <div class="col-md-6 form-group col-12 p-2"></div>--}}
