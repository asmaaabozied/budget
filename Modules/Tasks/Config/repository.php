...
return [
    ...
    */
    'generator' => [
        'basePath' => 'Modules\Tasks',
        'rootNamespace' => 'App\\',
        'stubsOverridePath' => app()->path(),
        'paths' => [
            'models' => 'Modules/Tasks/Entities',
            'repositories' => 'Modules/Tasks/Repositories',
            'interfaces' => 'Modules/Tasks/Interfaces',
            'transformers' => 'Modules/Tasks/Transformers',
            'presenters' => 'Modules/Tasks/Presenters',
            'validators' => 'Modules/Tasks/Validators',
            'controllers' => 'Modules/Tasks/Http/Controllers',
            'provider' => 'RepositoryServiceProvider',
            'criteria' => 'Modules/Tasks/Criteria',
        ],
    ],
];
