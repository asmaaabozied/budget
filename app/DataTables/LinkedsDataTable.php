...
class LinkedsDataTable extends DataTable
{
    private $crudName = 'linkeds';
     ...
     */
    public function query(Linked $model)
    {
    ...
    public function count()
    {
        if (auth()->user()->hasRole('Super Admin')) {
            ...
            return Linked::where('user_id', Auth::id())->count();
        }
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('link')->title(trans('site.link')),
            Column::make('employe_id')->title(trans('site.employee')),
