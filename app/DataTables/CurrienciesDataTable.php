...
class CurrienciesDataTable extends DataTable
{
    private $crudName = 'currencies';
    ...
    public function count()
    {
        if (auth()->user()->hasRole('Super Admin')) {
            ...
            return Currency::where('user_id', Auth::id())->count();
        }
    }
     ...
     *
     * @param  \App\Models\Curriency  $model
    ...
    {
        return 'Curriencies_'.date('YmdHis');
    }
}
